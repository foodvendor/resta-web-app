...
public interface IAdminStudentDAO extends JpaRepository<Student, Integer> {
	...
	@Query(value = "SELECT new com.NVDabbewala.rest.webservices.restfulwebservices.dto.StudentBranchDTO(s.studentName,s.studentEmail,s.studentAge,s.studentGender,b.branchName)"
